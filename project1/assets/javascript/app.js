...
document.getElementById("directionsLink").onclick = function() {
    this.href.append(latLng);
    console.log("apples");
}
        ...
        $.ajax({
            ...
            for (var i = 0; i < data.length; i++) { // Loop through JSON and create markers at latLng
                ...
                function addInfoText(marker, i) {
                    ...
                    tailoredSearch = "https://www.google.com/maps/search/?api=1&query=" + latLng;
                    ...
                    var contentString = 
                        ...
                        '<br \>' + '<a ID="directionsLink" href="https://www.google.com/maps/search/?api=1&query=a" ><h7>' + "Get Directions" + '</h7>' + '</a>' +
                        '</div>' +
                        '</div>';
...
//   function tailorDirections() {
//     $("a[href='https://www.google.com/maps/search/?api=1&query=a']")
//     .each(function()
//     { 
//        this.href = this.href.replace(latLng, 
//           "a");
//     });
